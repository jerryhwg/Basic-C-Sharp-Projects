...
namespace GenericBasic1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            employee.Things = new List<string>() { "FirstThing", "SecondThing", "ThirdThing" }; // Assign a list of strings as the property value of Things
            ...
            employeeID.Things = new List<int>() { 100, 200, 300 }; // Assign a list of integers as the propery value of Things
