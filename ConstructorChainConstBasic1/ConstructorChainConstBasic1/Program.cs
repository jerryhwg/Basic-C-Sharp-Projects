...
namespace ConstructorChainConstBasic1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var newRacer = new Racer("Max Rider"); // using constructor chain, 100 is taken as int racerLevel is not specified / var is useful when not sure which datatype, here var is used instead of Racer as datatype
